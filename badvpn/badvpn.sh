...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget raw.githubusercontent.com/modderajuda/Script/badvpn/badvpn-udpgw -o /dev/null
			wget raw.githubusercontent.com/modderajuda/Script/badvpn/antcrashvpn.sh -o /dev/null
